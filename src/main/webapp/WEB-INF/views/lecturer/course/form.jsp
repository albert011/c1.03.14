...
<acme:form>
	<acme:input-textbox code="lecturer.course.form.label.code"
		path="code" />
	...
	<jstl:choose>
		...
		<jstl:when
			...
			<acme:button code="lecturer.course.form.button.lectures-in-course" action="/lecturer/course-lecture/list-mine?courseId=${id}"/>
