...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.administrator"
			...
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.administrator.offer.list-all"
				action="/administrator/offer/list-all" />
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.administrator.currency"
				action="/administrator/currency/show" />
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.administrator.shut-down"
				action="/administrator/shut-down" />
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.administrator.banner.list-all"
				action="/administrator/banner/list-all" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.auditor"
			...
			<acme:menu-suboption code="master.menu.auditor.audit.list"
				action="/auditor/audit/list/" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.authenticated"
			...
			<acme:menu-suboption code="master.menu.authenticated.bulletins"
				action="/authenticated/bulletin-message/list" />
			<acme:menu-suboption code="master.menu.authenticated.tutorials"
				action="/authenticated/tutorial/list" />
			<acme:menu-suboption code="master.menu.authenticated.offer.list"
				action="/authenticated/offer/list" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.company"
			...
			<acme:menu-suboption code="master.menu.company.practicum.list-mine"
				action="/company/practicum/list-mine" />
			<acme:menu-suboption
				code="master.menu.company.practicum-session.list-mine"
				action="/company/practicum-session/list-mine" />
		</acme:menu-option>
