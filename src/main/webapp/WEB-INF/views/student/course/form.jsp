...
<acme:form>
	<acme:input-textbox code="student.course.form.label.code"
		path="code" />
		<acme:input-textbox code="student.course.form.label.title"
		path="title" />
	<acme:input-textbox code="student.course.form.label.abstract"
		path="abstract" />
	<acme:input-double
		code="student.course.form.label.retailPrice"
		path="retailPrice" />
